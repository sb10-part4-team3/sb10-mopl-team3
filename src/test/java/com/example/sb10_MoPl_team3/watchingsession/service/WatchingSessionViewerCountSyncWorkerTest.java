...
class WatchingSessionViewerCountSyncWorkerTest {
    ...
    private WatchingSessionViewerCountSyncWorker worker() {
        return new WatchingSessionViewerCountSyncWorker(redisRepository, contentStatsRepository);
    }
