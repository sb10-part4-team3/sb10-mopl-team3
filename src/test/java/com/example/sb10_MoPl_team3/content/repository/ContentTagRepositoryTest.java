...
class ContentTagRepositoryTest {
    ...
    void findTagsByContentIds_배치_조회_시_각_콘텐츠의_태그가_함께_반환된다() {
        ...
        assertThat(result).extracting(ContentTagProjection::contentId)
            .containsExactlyInAnyOrder(contentA.getId(), contentB.getId());
        assertThat(result).extracting(ContentTagProjection::tagName)
